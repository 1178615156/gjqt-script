...
from gjsp.skill.skill_loop_siming import SkillLoopSiMing
...
if __name__ == '__main__':
    ...
    hot_key = HotKey()
    hot_key.add_handler(GjDps(name="gj-dps", key="F8", windows=windows, skill_loop=SkillLoopSiMing(windows)))
    hot_key.add_handler(GjDpsPve(name="gj-dps-pve", key="F5", windows=windows, skill_loop=SkillLoopSiMing(windows)))
    hot_key.add_handler(GjDpsPvp(name="gj-dps-pvp", key="F6", windows=windows, skill_loop=SkillLoopSiMing(windows)))
